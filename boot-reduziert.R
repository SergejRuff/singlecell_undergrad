...
scsPipeline = function(SeuratObj){
  ...
  SeuratObj = FindClusters(SeuratObj, resolution = 0.5)#setzt random.seed=0
...
B=100
iteration=vector(mode="list",length=B)
...
setwd("A:/RFILES/bootstrap/22062022")
...
write.table(result,"101Bootstraping150822.csv",quote=FALSE,sep=";")
